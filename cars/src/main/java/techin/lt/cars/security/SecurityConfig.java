package techin.lt.cars.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cars").hasAnyAuthority("SCOPE_ROLE_ADMIN", "SCOPE_ROLE_USER")
                        .requestMatchers(HttpMethod.GET, "/api/cars/{id}").hasAnyAuthority("SCOPE_ROLE_ADMIN", "SCOPE_ROLE_USER")
                        .anyRequest().authenticated() //if not working permitAll()use this
                )
